...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/active_record_spec.rb", "spec/data_mapper_spec.rb", "spec/db/schema.rb", "spec/machinist_spec.rb", "spec/sequel_spec.rb", "spec/sham_spec.rb", "spec/spec_helper.rb"]
